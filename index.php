...
<div style="margin-bottom: 20px;">
    <span style="font-size: 200%;">
        <span id="isCurrentlyWorking-true" style="color: #2c2; display: none;"><!-- aktuálně pracuje -->Napiště mi: <span id='alert3Warning' style="color: #292;">Nepracuj nebo nepůjdeš do RTsoftu!</span></span>
